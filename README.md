...
| **Wpływ nasycenia (Hamilton)**       | Bardzo wysokie nasycenie sprawia, że algorytm szybko trafia na cykl. Najgorzej jest w grafach gęstych, w których **nie ma cyklu** – algorytm musi wtedy powracać (backtracking) tysiące razy, co drastycznie wydłuża czas.                                            |
